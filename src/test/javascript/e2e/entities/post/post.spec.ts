...
describe('Post e2e test', () => {
    ...
    it('should load Posts', async () => {
        ...
        expect(await postComponentsPage.getTitle()).toMatch(/ethboardApp.post.home.title/);
    });

    it('should load create Post page', async () => {
        await postComponentsPage.clickOnCreateButton();
        postUpdatePage = new PostUpdatePage();
        expect(await postUpdatePage.getPageTitle()).toMatch(/ethboardApp.post.home.createOrEditLabel/);
    ...
    it('should create and save Posts', async () => {
        ...
        await postUpdatePage.setOwnerNameInput('ownerName');
        expect(await postUpdatePage.getOwnerNameInput()).toMatch('ownerName');
    ...
    it('should delete last Post', async () => {
        ...
        expect(await postDeleteDialog.getDialogTitle()).toMatch(/ethboardApp.post.delete.question/);
