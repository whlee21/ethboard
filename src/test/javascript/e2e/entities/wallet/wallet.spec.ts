...
describe('Wallet e2e test', () => {
    ...
    it('should load Wallets', async () => {
        ...
        expect(await walletComponentsPage.getTitle()).toMatch(/ethboardApp.wallet.home.title/);
    });
    ...
    it('should load create Wallet page', async () => {
        ...
        expect(await walletUpdatePage.getPageTitle()).toMatch(/ethboardApp.wallet.home.createOrEditLabel/);
    ...
    it('should delete last Wallet', async () => {
        ...
        expect(await walletDeleteDialog.getDialogTitle()).toMatch(/ethboardApp.wallet.delete.question/);
